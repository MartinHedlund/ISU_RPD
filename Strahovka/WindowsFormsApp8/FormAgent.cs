...
namespace WindowsFormsApp8
{
    public partial class FormAgent : Form
    {
        ...
        static string phone = "";
        static int filial = 0;
        Agent agent = new Agent(idClient,surName,name,patron,adress,phone, filial);
        static int idFil = 0;
        Filial filil = new Filial(idFil, name, adress, phone);
        ...
        {
            agent.Del(Convert.ToInt32(textBoxIdClient.Text));
            VisibDel(false);
            textBoxInfo.Text = agent.Print();
        }
        ...
        {
            agent.Add(Convert.ToInt32(textBoxIdClient.Text), textBoxSuraName.Text, textBoxName.Text, textBoxPatron.Text, textBoxAdress.Text, textBoxPhone.Text, Convert.ToInt32(textBoxFilial.Text));
            VisibAdd(false);
            textBoxInfo.Text = agent.Print();
        }
